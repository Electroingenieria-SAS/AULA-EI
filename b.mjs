...
const passwordGate = 'function AULA_PasswordGate(){const[n,a]=j.useState(""),[r,l]=j.useState(""),[o,c]=j.useState(""),[f,p]=j.useState(!1),m=async g=>{g.preventDefault(),c("");if(n!==r){c("Las contraseñas no coinciden.");return}if(n.length<10||n.length>128||/\\s/.test(n)||!/[a-z]/.test(n)||!/[A-Z]/.test(n)||!/[0-9]/.test(n)||!/[^A-Za-z0-9]/.test(n)){c("Usa entre 10 y 128 caracteres, con mayúscula, minúscula, número y símbolo, sin espacios.");return}p(!0);try{const{data:b,error:v}=await re.functions.invoke("complete-password-change",{body:{password:n}});if(v)throw new Error(String(b?.error||v.message||"No fue posible actualizar la contraseña."));if(b?.ok===!1)throw new Error(String(b?.error||"No fue posible actualizar la contraseña."));c("Contraseña actualizada. Por seguridad debes iniciar sesión nuevamente."),await re.auth.signOut(),window.location.hash="/login",setTimeout(()=>window.location.reload(),250)}catch(b){c(jl(b,"No fue posible actualizar la contraseña."))}finally{p(!1)}};return d.jsx("main",{className:"startup-page",children:d.jsxs("section",{className:"startup-card",children:[d.jsx("div",{className:"startup-logo",children:"EI"}),d.jsx("h1",{children:"Crea tu contraseña personal"}),d.jsx("p",{children:"Esta cuenta fue creada con una contraseña temporal. Antes de continuar debes establecer una contraseña personal segura."}),d.jsxs("form",{className:"auth-form",onSubmit:m,children:[d.jsxs("label",{children:["Nueva contraseña",d.jsx("input",{type:"password",autoComplete:"new-password",minLength:10,maxLength:128,value:n,onChange:g=>a(g.target.value),required:!0})]}),d.jsxs("label",{children:["Confirmar contraseña",d.jsx("input",{type:"password",autoComplete:"new-password",minLength:10,maxLength:128,value:r,onChange:g=>l(g.target.value),required:!0})]}),d.jsx("small",{className:"helper-text",children:"Mínimo 10 caracteres con mayúscula, minúscula, número y símbolo."}),d.jsx("button",{className:"primary-button",disabled:f,children:f?"Actualizando…":"Guardar contraseña y continuar"}),o&&d.jsx("p",{className:"form-message",children:o})]})]})})}';
bundle = replaceExactly(bundle, 'function cg({children:n,admin:a=!1}){', passwordGate + 'function cg({children:n,admin:a=!1}){', 'E8');
bundle = replaceExactly(
  bundle,
  '):r?a&&!l?d.jsx(Cl,{to:"/",replace:!0}):d.jsx(d.Fragment,{children:n}):d.jsx(Cl,{to:"/login",replace:!0,state:{authError:c}})}',
  '):r?(r.app_metadata?.aula_ei_must_change_password===true||r.user_metadata?.must_change_password===true)?d.jsx(AULA_PasswordGate,{}):a&&!l?d.jsx(Cl,{to:"/",replace:!0}):d.jsx(d.Fragment,{children:n}):d.jsx(Cl,{to:"/login",replace:!0,state:{authError:c}})}',
  'E9'
);
...
bundle = replaceExactly(
  ...
  'children:"Se muestra una sola vez. Si la escribes manualmente debe tener mínimo 10 caracteres, mayúscula, minúscula, número y símbolo."',
  'E29'
);
