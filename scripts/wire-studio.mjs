...
const studioAssetsDir = path.join(dist, 'studio', 'assets')
...
const studioAtStart=studioRoute.test(window.location.hash);
window.addEventListener('hashchange',()=>{if(studioRoute.test(window.location.hash)!==studioAtStart)window.location.reload()});
if(studioAtStart){
