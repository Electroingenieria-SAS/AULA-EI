...
const jsFiles = (await readdir(assetsDir)).filter((name) => /^index-.*n.length<12||n.length>128.js$/.test(name));
...
// Preserve the pre-21/09 app while isolating its browser session from later builds.
